...
PATH_ROMI = romi
PATH_COMM = $(PATH_ROMI)/common
PATH_NET = $(PATH_ROMI)/net
PATH_TCP = $(PATH_ROMI)/net/tcp
PATH_CODER = $(PATH_ROMI)/net/coder
PATH_RPC = $(PATH_ROMI)/net/rpc

PATH_TESTCASES = testcases

# will install lib to /usr/lib/libromi.a
PATH_INSTALL_LIB_ROOT = /usr/lib

# will install all header file to /usr/include/romi
...
CXXFLAGS += -I./ -I$(PATH_ROMI)	-I$(PATH_COMM) -I$(PATH_NET) -I$(PATH_TCP) -I$(PATH_CODER) -I$(PATH_RPC)
...
$(LIB_OUT): $(COMM_OBJ) $(NET_OBJ) $(TCP_OBJ) $(CODER_OBJ) $(RPC_OBJ)
	cd $(PATH_OBJ) && ar rcv libromi.a *.o && cp libromi.a ../lib/
...
# to clean 
clean :
	rm -f $(COMM_OBJ) $(NET_OBJ) $(TESTCASES) $(TEST_CASE_OUT) $(PATH_LIB)/libromi.a $(PATH_OBJ)/libromi.a $(PATH_OBJ)/*.o
...
# uninstall
uninstall:
	rm -rf $(PATH_INSTALL_INC_ROOT)/romi && rm -f $(PATH_INSTALL_LIB_ROOT)/libromi.a