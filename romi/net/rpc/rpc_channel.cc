...
#include "romi/net/rpc/rpc_channel.h"
#include "romi/net/rpc/rpc_controller.h"
#include "romi/net/coder/tinypb_protocol.h"
#include "romi/net/tcp/tcp_client.h"
#include "romi/common/log.h"
#include "romi/common/msg_id_util.h"
#include "romi/common/error_code.h"
#include "romi/common/run_time.h"
...
void RpcChannel::CallMethod(const google::protobuf::MethodDescriptor* method,
  ...
  std::shared_ptr<romi::TinyPBProtocol> req_protocol = std::make_shared<romi::TinyPBProtocol>();
  ...
  m_client->connect([req_protocol, this]() mutable {
    ...
    getTcpClient()->writeMessage(req_protocol, [req_protocol, this, my_controller](AbstractProtocol::s_ptr) mutable {
      INFOLOG("%s | send rpc request success. call method name[%s], peer addr[%s], local addr[%s]", 
        ...
        std::shared_ptr<romi::TinyPBProtocol> rsp_protocol = std::dynamic_pointer_cast<romi::TinyPBProtocol>(msg);
