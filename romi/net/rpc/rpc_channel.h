#ifndef ROMI_NET_RPC_RPC_CHANNEL_H
#define ROMI_NET_RPC_RPC_CHANNEL_H
...
#define NEWRPCCONTROLLER(var_name) \
  std::shared_ptr<romi::RpcController> var_name = std::make_shared<romi::RpcController>(); \

#define NEWRPCCHANNEL(addr, var_name) \
  std::shared_ptr<romi::RpcChannel> var_name = std::make_shared<romi::RpcChannel>(romi::RpcChannel::FindAddr(addr)); \
