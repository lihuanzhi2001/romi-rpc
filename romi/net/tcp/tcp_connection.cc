...
#include "romi/net/fd_event_group.h"
#include "romi/net/tcp/tcp_connection.h"
#include "romi/net/coder/string_coder.h"
#include "romi/net/coder/tinypb_coder.h"
...
void TcpConnection::excute() {
  if (m_connection_type == TcpConnectionByServer) {
    ...
    for (size_t i = 0;  i < result.size(); ++i) {
      ...
      // message->m_pb_data = "hello. this is romi rpc test data";
